            ...
            <div id="content-wrap">
                <div id="main">				
                    ...
                    <form id="formSubmit" method="post" >
                        ...
                        <input type="text" class="validate[required]" class="Tfield" readonly value='<?php echo $data['startDate']; ?>' name="startDate" 
						id="startDate" />
                        <input type="text" class="validate[required]" class="Tfield" readonly value='<?php echo $data['endDate']; ?>' name="endDate" 
						id="endDate" />
