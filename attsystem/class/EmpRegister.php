    ...
    function Add() {
        $qry = "INSERT INTO `employee_detail` 
            ( `EmpName`, `EmpAddress`, `EmpMobile`, 
              `EmpEmail`, `EmpBirthdate`, `EmpGroup`, `EmpTechnology`) 
            VALUES 
            ( '{$_POST['EmpName']}', '{$_POST['EmpAddress']}', '{$_POST['EmpMobile']}', 
              '{$_POST['EmpEmail']}', '{$_POST['EmpBirthdate']}', '{$_POST['EmpGroup']}', '{$_POST['EmpTechnology']}','{$_POST['password']}')";
