...
$sql="SELECT ID, FirstName, LastName FROM  WHERE FirstName LIKE '%" . $name . "%' OR LastName LIKE '%" . $name ."%'";
...
//-query the database table
$sql="SELECT ID, FirstName, LastName FROM  WHERE FirstName LIKE '%" . $letter . "%' OR LastName LIKE '%" . $letter ."%'";
...
//-query the database table
$sql="SELECT * FROM a_search WHERE ID=" . $contactid;
